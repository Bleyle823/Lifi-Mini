...
export function SafeArea({
  ...
  useEffect(() => {
    ...
    setProperties([
      ...
      ["--pb-content", contentBottomPadding],
      ["--pt-content", contentTopPadding],
    ]);
  ...
  return (
    <>
      ...
      <div className="px-safe mt-[calc(var(--safe-area-inset-top)+var(--t-nav))] mr-[var(--safe-area-inset-right)] mb-[calc(var(--safe-area-inset-bottom)+var(--b-nav))] ml-[var(--safe-area-inset-left)]">
        <div className="max-w-global mx-auto pt-[var(--pt-content)] pb-[var(--pb-content)]">
          {children}
        </div>
      </div>
    </>
