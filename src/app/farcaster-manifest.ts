...
export const farcasterManifest: Manifest = {
  ...
  frame: {
    ...
    splashImageUrl: `${appUrl}/icon-192x192.png`,
    splashBackgroundColor: "#0F172A",
    // webhookUrl: "https://api.example.com/webhook/farcaster",
    subtitle: "Cross-chain bridge for seamless token transfers",
    description:
    ...
    heroImageUrl: `${appUrl}/icon-512x512.png`,
    ...
    ogImageUrl: `${appUrl}/icon-512x512.png`,
    noindex: false,
